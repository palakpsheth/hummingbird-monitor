...
make test-unit       # unit tests + coverage (tests/unit)
make test-integration # integration/UI tests + coverage (tests/integration)
make docker-build    # docker compose build
make docker-up       # docker compose up -d --build
make docker-down     # docker compose down
make clean-db        # remove local database + config files (defaults to ./data)
